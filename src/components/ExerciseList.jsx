...
import ExerciseCard from './ExerciseCard'; // Make sure this path is correct
  ...
  const [exercises, setExercises] = useState([
    {
      ...
      difficulty: 'beginner',
      instructions:
        'Start in a plank position. Lower your body until your chest nearly touches the floor, then push back up to starting position.',
    },
    {
      id: 2,
      name: 'Squats',
      ...
      difficulty: 'beginner',
      instructions:
        'Stand with feet shoulder-width apart. Lower your body as if sitting back into a chair, then return to standing position.',
    },
    {
      id: 3,
      name: 'Deadlifts',
      ...
      instructions:
        'Stand with feet hip-width apart, grip the barbell. Keep your back straight as you lift the weight by extending your hips and knees.',
    },
  ]);
